...
int main() {
    ...
    /* INADDR_ANY (0.0.0.0) tells the operating system:
       "Bind to any available network interface on this machine"
        This means the program will listen for incoming connections on all available IP addresses of the device. */
    servaddr.sin_port = htons(PORT);
    //servaddr.sin_addr.s_addr = INADDR_ANY;
    // Change from INADDR_ANY to loopback address (localhost)
